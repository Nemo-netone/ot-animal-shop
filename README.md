...
| 项目 | 地址 |
|---|---|
| GitHub 仓库 | https://github.com/Nemo-netone/ot-animal-shop |
| 演示地址 | https://ot-animal-shop.pages.dev |
| 生产分支 | `main` |
| Cloudflare Pages | `ot-animal-shop` |
| Supabase schema | `ot_animal_shop` |

## 演示账号

| 类型 | 用户名 | 密码 | 权限 |
|---|---|---|---|
| 平台管理员 | `admin@qq.com` | `123` | admin |
| 商城用户 | `demo@qq.com` | `123456` | user |
| 供应商 | `supplier01` | `123456` | staff |
...
- 原始项目：Vue + Spring Boot + MySQL，原始 SQL 位于 shopping_pet.sql。
- 线上演示：Cloudflare Pages + Pages Functions + Supabase
- 数据隔离：所有演示数据写入 `ot_animal_shop`，不覆盖 Supabase `public` 或其他项目 schema
...
SUPABASE_SCHEMA=ot_animal_shop
CORS_ALLOWED_ORIGINS=https://ot-animal-shop.pages.dev
```
